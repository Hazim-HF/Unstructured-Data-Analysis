...
Au6=normalize(bind(Au1+Au2), unit='32')  #combine sound in one sound
play(Au6)

#Try data tico from notes seewave
...
## y is signal. span = smoothing parameter. log c= dont want y axis 
## in term of log
