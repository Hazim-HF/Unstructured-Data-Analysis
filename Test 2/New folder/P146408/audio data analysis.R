...
# the sampling rate
t = seq(0, 2, 1/sr) 
# times in secs if sample for 2 seconds at 8KHz
...
play(w1)
# sine wave a 440 Hz scaled to fill out 16 bit range
# make the Wave representation
#Compare w and w1
...
babycry<-readWave(choose.files())
z = babycry
#or z = readWave("babycry.wav")
play(z)
