...
babycry = readWave("C:/Users/PC 12/Downloads/au-20250527/babycry.wav")
#play(babycry)
plot(babycry)
spectro(babycry)
timer(babycry, f=22050, threshold =20, msmooth = c(100,0))
babyfft = fft(babycry@left)
plot.frequency.spectrum(babyfft[1:(length(babyfft)/2)])
#dynspec(babycry, wl=1024, osc=T)
spectro(babycry)
meanspec(babycry)
